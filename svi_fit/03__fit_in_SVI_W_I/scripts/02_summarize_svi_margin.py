"""Calculate SVI stability margins and write equal-weighting reports."""
...
PROCESSED_PATH = PROCESSED_DIR / "svi_fit_equal_weighting.csv"
REPORT_PATH = REPORT_DIR / "calibration_quality_equal_weighting.txt"
...
def write_quality_report(table: pd.DataFrame) -> None:
    """Write an English summary report for the equal-weighted calibration."""
    lines = [
        "Equal-weighted SVI calibration quality",
        "======================================",
        "",
