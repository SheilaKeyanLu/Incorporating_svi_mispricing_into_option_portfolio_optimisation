...
from portfolio_optimisation import historical_mean_variance


PARAMETERS = {
    "model_name": "Historical Mean-Variance",
    "lambda_risk": 100,
    "tau": TAU_FIXED,
    "delta": None,
    "xi": XI_FIXED,
...
if __name__ == "__main__":
    ...
    result = run_fixed_parameter_backtest(
        ...
        optimisation_module=historical_mean_variance,
        output_dir=MODEL_OUTPUT_DIRS["historical_mean_variance"],
    )
