...
from portfolio_optimisation import delta_gamma_approximation


PARAMETERS = {
    "model_name": "Delta-Gamma Approximation",
    "lambda_risk": 100,
    "tau": TAU_FIXED,
    "delta": None,
    "xi": XI_FIXED,
...
if __name__ == "__main__":
    ...
    result = run_fixed_parameter_backtest(
        ...
        optimisation_module=delta_gamma_approximation,
        output_dir=MODEL_OUTPUT_DIRS["delta_gamma_approximation"],
    )
